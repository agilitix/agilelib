...
namespace AxFixEntities
{
  ...
  {
    private static IDictionary<string, string> _possibleValues = new Dictionary<string, string> {{"1","NotHeld"},{"2","Work"},{"3","GoAlong"},{"4","OverTheDay"},{"5","Held"},{"6","ParticipateDontInitiate"},{"7","StrictScale"},{"8","TryToScale"},{"9","StayOnBidside"},{"0","StayOnOfferside"},{"A","NoCross"},{"B","OkToCross"},{"C","CallFirst"},{"D","PercentOfVolume"},{"E","DoNotIncrease"},{"F","DoNotReduce"},{"G","AllOrNone"},{"H","ReinstateOnSystemFailure"},{"I","InstitutionsOnly"},{"J","ReinstateOnTradingHalt"},{"K","CancelOnTradingHalt"},{"L","LastPeg"},{"M","MidPrice"},{"N","NonNegotiable"},{"O","OpeningPeg"},{"P","MarketPeg"},{"Q","CancelOnSystemFailure"},{"R","PrimaryPeg"},{"S","Suspend"},{"T","FixedPegToLocalBestBidOrOfferAtTimeOfOrder"},{"U","CustomerDisplayInstruction"},{"V","Netting"},{"W","PegToVwap"},{"X","TradeAlong"},{"Y","TryToStop"},{"Z","CancelIfNotBest"},{"a","TrailingStopPeg"},{"b","StrictLimit"},{"c","IgnorePriceValidityChecks"},{"d","PegToLimitPrice"},{"e","WorkToTargetStrategy"},};
    private readonly string _value;
  ...
  {
    private static IDictionary<string, string> _possibleValues = new Dictionary<string, string> {{"EUSUPRA","EuroSupranationalCoupons"},{"FAC","FederalAgencyCoupon"},{"FADN","FederalAgencyDiscountNote"},{"PEF","PrivateExportFunding"},{"SUPRA","UsdSupranationalCoupons"},{"FUT","Future"},{"OPT","Option"},{"CORP","CorporateBond"},{"CPP","CorporatePrivatePlacement"},{"CB","ConvertibleBond"},{"DUAL","DualCurrency"},{"EUCORP","EuroCorporateBond"},{"XLINKD","IndexedLinked"},{"STRUCT","StructuredNotes"},{"YANK","YankeeCorporateBond"},{"FOR","ForeignExchangeContract"},{"CS","CommonStock"},{"PS","PreferredStock"},{"BRADY","BradyBond"},{"EUSOV","EuroSovereigns"},{"TBOND","UsTreasuryBond"},{"TINT","InterestStripFromAnyBondOrNote"},{"TIPS","TreasuryInflationProtectedSecurities"},{"TCAL","PrincipalStripOfACallableBondOrNote"},{"TPRN","PrincipalStripFromANonCallableBondOrNote"},{"TNOTE","UsTreasuryNote"},{"TBILL","UsTreasuryBill"},{"REPO","Repurchase"},{"FORWARD","Forward"},{"BUYSELL","BuySellback"},{"SECLOAN","SecuritiesLoan"},{"SECPLEDGE","SecuritiesPledge"},{"TERM","TermLoan"},{"RVLV","RevolverLoan"},{"RVLVTRM","RevolverTermLoan"},{"BRIDGE","BridgeLoan"},{"LOFC","LetterOfCredit"},{"SWING","SwingLineFacility"},{"DINP","DebtorInPossession"},{"DEFLTED","Defaulted"},{"WITHDRN","Withdrawn"},{"REPLACD","Replaced"},{"MATURED","Matured"},{"AMENDED","AmendedAndRestated"},{"RETIRED","Retired"},{"BA","BankersAcceptance"},{"BN","BankNotes"},{"BOX","BillOfExchanges"},{"CD","CertificateOfDeposit"},{"CL","CallLoans"},{"CP","CommercialPaper"},{"DN","DepositNotes"},{"EUCD","EuroCertificateOfDeposit"},{"EUCP","EuroCommercialPaper"},{"LQN","LiquidityNote"},{"MTN","MediumTermNotes"},{"ONITE","Overnight"},{"PN","PromissoryNote"},{"PZFJ","PlazosFijos"},{"STN","ShortTermLoanNote"},{"TD","TimeDeposit"},{"XCN","ExtendedCommNote"},{"YCD","YankeeCertificateOfDeposit"},{"ABS","AssetBackedSecurities"},{"CMBS","CorpMortgageBackedSecurities"},{"CMO","CollateralizedMortgageObligation"},{"IET","IoetteMortgage"},{"MBS","MortgageBackedSecurities"},{"MIO","MortgageInterestOnly"},{"MPO","MortgagePrincipalOnly"},{"MPP","MortgagePrivatePlacement"},{"MPT","MiscellaneousPassThrough"},{"PFAND","Pfandbriefe"},{"TBA","ToBeAnnounced"},{"AN","OtherAnticipationNotes"},{"COFO","CertificateOfObligation"},{"COFP","CertificateOfParticipation"},{"GO","GeneralObligationBonds"},{"MT","MandatoryTender"},{"RAN","RevenueAnticipationNote"},{"REV","RevenueBonds"},{"SPCLA","SpecialAssessment"},{"SPCLO","SpecialObligation"},{"SPCLT","SpecialTax"},{"TAN","TaxAnticipationNote"},{"TAXA","TaxAllocation"},{"TECP","TaxExemptCommercialPaper"},{"TRAN","TaxAndRevenueAnticipationNote"},{"VRDN","VariableRateDemandNote"},{"WAR","Warrant"},{"MF","MutualFund"},{"MLEG","MultiLegInstrument"},{"NONE","NoSecurityType"},{"?","Wildcard"},};
    private readonly string _value;
  ...
  {
    private static IDictionary<string, string> _possibleValues = new Dictionary<string, string> {{"AMT","Amt"},{"AUTOREINV","AutoReinvestmentAtOrBetter"},{"BANKQUAL","BankQualified"},{"BGNCON","BargainConditions"},{"COUPON","CouponRange"},{"CURRENCY","IsoCurrencyCode"},{"CUSTOMDATE","CustomStartEndDate"},{"GEOG","GeographicsAndPercentRange"},{"HAIRCUT","ValuationDiscount"},{"INSURED","Insured"},{"ISSUE","YearOrYearMonthOfIssue"},{"ISSUER","IssuersTicker"},{"ISSUESIZE","IssueSizeRange"},{"LOOKBACK","LookbackDays"},{"LOT","ExplicitLotIdentifier"},{"LOTVAR","LotVariance"},{"MAT","MaturityYearAndMonth"},{"MATURITY","MaturityRange"},{"MAXSUBS","MaximumSubstitutions"},{"MINQTY","MinimumQuantity"},{"MININCR","MinimumIncrement"},{"MINDNOM","MinimumDenomination"},{"PAYFREQ","PaymentFrequencyCalendar"},{"PIECES","NumberOfPieces"},{"PMAX","PoolsMaximum"},{"PPM","PoolsPerMillion"},{"PPL","PoolsPerLot"},{"PPT","PoolsPerTrade"},{"PRICE","PriceRange"},{"PRICEFREQ","PricingFrequency"},{"PROD","ProductionYear"},{"PROTECT","CallProtection"},{"PURPOSE","Purpose"},{"PXSOURCE","BenchmarkPriceSource"},{"RATING","RatingSourceAndRange"},{"RESTRICTED","Restricted"},{"SECTOR","MarketSector"},{"SECTYPE","SecuritytypeIncludedOrExcluded"},{"STRUCT","Structure"},{"SUBSFREQ","SubstitutionsFrequency"},{"SUBSLEFT","SubstitutionsLeft"},{"TEXT","FreeformText"},{"TRDVAR","TradeVariance"},{"WAC","WeightedAverageCoupon"},{"WAL","WeightedAverageLifeCoupon"},{"WALA","WeightedAverageLoanAge"},{"WAM","WeightedAverageMaturity"},{"WHOLE","WholePool"},{"YIELD","YieldRange"},{"SMM","SingleMonthlyMortality"},{"CPR","ConstantPrepaymentRate"},{"CPY","ConstantPrepaymentYield"},{"CPP","ConstantPrepaymentPenalty"},{"ABS","AbsolutePrepaymentSpeed"},{"MPR","MonthlyPrepaymentRate"},{"PSA","PercentOfBmaPrepaymentCurve"},{"PPC","PercentOfProspectusPrepaymentCurve"},{"MHP","PercentOfManufacturedHousingPrepaymentCurve"},{"HEP","FinalCprOfHomeEquityPrepaymentCurve"},};
    private readonly string _value;
  ...
  {
    private static IDictionary<string, string> _possibleValues = new Dictionary<string, string> {{"AFTERTAX","AfterTaxYield"},{"ANNUAL","AnnualYield"},{"ATISSUE","YieldAtIssue"},{"AVGMATURITY","YieldToAverageMaturity"},{"BOOK","BookYield"},{"CALL","YieldToNextCall"},{"CHANGE","YieldChangeSinceClose"},{"CLOSE","ClosingYield"},{"COMPOUND","CompoundYield"},{"CURRENT","CurrentYield"},{"GROSS","TrueGrossYield"},{"GOVTEQUIV","GovernmentEquivalentYield"},{"INFLATION","YieldWithInflationAssumption"},{"INVERSEFLOATER","InverseFloaterBondYield"},{"LASTCLOSE","MostRecentClosingYield"},{"LASTMONTH","ClosingYieldMostRecentMonth"},{"LASTQUARTER","ClosingYieldMostRecentQuarter"},{"LASTYEAR","ClosingYieldMostRecentYear"},{"LONGAVGLIFE","YieldToLongestAverageLife"},{"MARK","MarkToMarketYield"},{"MATURITY","YieldToMaturity"},{"NEXTREFUND","YieldToNextRefund"},{"OPENAVG","OpenAverageYield"},{"PUT","YieldToNextPut"},{"PREVCLOSE","PreviousCloseYield"},{"PROCEEDS","ProceedsYield"},{"SEMIANNUAL","SemiAnnualYield"},{"SHORTAVGLIFE","YieldToShortestAverageLife"},{"SIMPLE","SimpleYield"},{"TAXEQUIV","TaxEquivalentYield"},{"TENDER","YieldToTenderDate"},{"TRUE","TrueYield"},{"VALUE1_32","YieldValueOf132"},{"WORST","YieldToWorst"},};
    private readonly string _value;
