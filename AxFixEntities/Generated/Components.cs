...
namespace FIX44.Entities
{
    public struct Instrument
    {
        ...
        public struct NoSecurityAltIDItem
        {
    ...
    public struct UnderlyingInstrument
    {
        ...
        public struct NoUnderlyingSecurityAltIDItem
        {
    ...
    public struct InstrumentLeg
    {
        ...
        public struct NoLegSecurityAltIDItem
        {
    ...
    public struct NestedParties
    {
        public NoNestedPartyIDsItem[] NoNestedPartyIDs { get; set; }

        public struct NoNestedPartyIDsItem
        {
    ...
    public struct NestedParties2
    {
        public NoNested2PartyIDsItem[] NoNested2PartyIDs { get; set; }

        public struct NoNested2PartyIDsItem
        {
    ...
    public struct NestedParties3
    {
        public NoNested3PartyIDsItem[] NoNested3PartyIDs { get; set; }

        public struct NoNested3PartyIDsItem
        {
    ...
    public struct SettlParties
    {
        public NoSettlPartyIDsItem[] NoSettlPartyIDs { get; set; }

        public struct NoSettlPartyIDsItem
        {
    ...
    public struct SpreadOrBenchmarkCurveData
    {
    ...
    public struct LegBenchmarkCurveData
    {
    ...
    public struct Stipulations
    {
        ...
        public struct NoStipulationsItem
        {
    ...
    public struct UnderlyingStipulations
    {
        public NoUnderlyingStipsItem[] NoUnderlyingStips { get; set; }

        public struct NoUnderlyingStipsItem
        {
    ...
    public struct LegStipulations
    {
        public NoLegStipulationsItem[] NoLegStipulations { get; set; }

        public struct NoLegStipulationsItem
        {
    ...
    public struct PositionQty
    {
        public NoPositionsItem[] NoPositions { get; set; }

        public struct NoPositionsItem
        {
    ...
    public struct PositionAmountData
    {
        public NoPosAmtItem[] NoPosAmt { get; set; }

        public struct NoPosAmtItem
        {
    ...
    public struct TrdRegTimestamps
    {
        public NoTrdRegTimestampsItem[] NoTrdRegTimestamps { get; set; }

        public struct NoTrdRegTimestampsItem
        {
    ...
    public struct SettlInstructionsData
    {
    ...
    public struct DiscretionInstructions
    {
    ...
    public struct FinancingDetails
    {
