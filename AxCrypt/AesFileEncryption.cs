...
namespace AxCrypt
{
    public class AesFileEncryption
    {
        ...
        {
            Run(sourceFilename, destinationFilename, password, Mode.Encrypt);
        }

        public void DecryptFile(string sourceFilename, string destinationFilename, string password)
        {
            Run(sourceFilename, destinationFilename, password, Mode.Decrypt);
        }

        private void Run(string sourceFilename, string destinationFilename, string password, Mode mode)
        {
